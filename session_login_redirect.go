...
// DoSessionLoginRedirect redirects request to login page.
func (m *AuthPortal) DoSessionLoginRedirect(w http.ResponseWriter, r *http.Request, opts map[string]interface{}) error {
