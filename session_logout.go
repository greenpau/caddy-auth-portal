...
// DoSessionLogoff performs session logout sequence.
func (m *AuthPortal) DoSessionLogoff(w http.ResponseWriter, r *http.Request, opts map[string]interface{}) error {
