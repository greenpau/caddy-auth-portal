...
const (
	...
	ErrBackendOauthInitFailed                          StandardError = "failed to initialize OAuth 2.0"
	ErrBackendOauthAddStateFailed                      StandardError = "failed to add state to OAuth 2.0"
	ErrBackendOauthAddCodeFailed                       StandardError = "failed to add code to OAuth 2.0's state"
