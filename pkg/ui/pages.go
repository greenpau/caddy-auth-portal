  ...
  <body class="app-background">
    <div class="container app-container">
      ...
      <div class="row">
	    ...
	    <div class="row">
	      <div class="col right">
                <a class="waves-effect waves-light btn modal-trigger" href="{{ .ActionEndpoint }}/settings/mfa/add">Add MFA Device</a>
	      </div>
            </div>
	    <div class="row">
            {{ if .Data.mfa_devices }}
          ...
          {{ end }}
	  {{ if eq .Data.view "mfa-add" }}
            <form action="{{ .ActionEndpoint }}/settings/mfa/add" method="POST">
              <div class="row">
                <h1>Add MFA Device</h1>
		<div class="row">
