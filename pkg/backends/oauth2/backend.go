...
func (b *Backend) ConfigureAuthenticator() error {
	...
	if err := b.Authenticator.ConfigureRealm(b.Realm); err != nil {
		b.logger.Error("failed configuring realm (domain) for OAuth 2.0 authentication",
...
func (b *Backend) Validate() error {
	...
	b.logger.Info("validating OAuth 2.0 backend")

	if b.Authenticator == nil {
		return fmt.Errorf("OAuth 2.0 authenticator is nil")
	}
